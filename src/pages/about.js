            ...
            <div className="grid w-full grid-cols-8 gap-16 mt-8">
              <div className="col-span-3 flex flex-col items-start justify-start mt-16">
                ...
                <p className="font-medium mb-4">
                  Hello, I&apos;m Arjun, a results-driven web developer and
                  UI/UX designer who is passionate about crafting beautiful,
                  functional, and user-centered digital experiences. I believe
                  that great design not only solves problems and creates
                  enjoyable experiences but also optimizes performance and
                  enhances search engine visibility.
                </p>

                <p className="font-medium my-4">
                  When working on websites, mobile apps, or any other digital
                  products, I prioritize design excellence, user-centric
                  thinking, and technical expertise. I understand the importance
                  of creating designs that not only look impressive but also
                  load quickly, perform efficiently, and provide a seamless user
                  experience.
                </p>
